    ...
    var x, y = "",
        ...
        g = {
            init: function(a) {
                ...
                h(document).bind(I.move, function(a) {
                    for (var b in c.pages) p(b, c.pages) && i._eventMove.call(c.pages[b], a) }).bind(I.end, function(a) {
            ...
            _end: function(a,
                ...
                a.stopPropagation();
                if (b || e.tpage) {
                    if (e.tpage == c.next || e.tpage == c.page) delete e.tpage, g._fitPage.call(d, e.tpage || c.next, !0) } else g._removeMv.call(d, c.pageMv), d.turn("update") },
            _pressed: function() {
            ...
            update: function() {
                ...
                if (b.pageMv.length && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap) p(a, b.pageWrap) && (b.pageWrap[a].css({ display: c.pageV[a] ? "" : "none", "z-index": c.pageZ[a] || 0 }), b.pages[a] && (b.pages[a].flip("z", c.partZ[a] || null), c.pageV[a] && b.pages[a].flip("resize"), b.tpage && b.pages[a].flip("disable", !0))) } else
        ...
        i = {
            ...
            _moveFoldingPage: function(a) {
                ...
                if (c)
                    if (a) {
                        if (!b.fpage.children()[b.ashadow ? "1" : "0"]) i.setData.call(this, { backParent: c.parent() }), b.fpage.prepend(c) } else b.backParent && b.backParent.prepend(c) },
            ...
            disable: function(a) { i.setData.call(this, { disabled: a });
                return this }
        },
        N = function(a, b, c) {
